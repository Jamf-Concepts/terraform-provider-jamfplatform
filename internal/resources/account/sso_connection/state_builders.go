...
// nothing at all.
//
// `pkce` is read through pkceForConnectionType rather than adopted, because Jamf
// returns one for every connection and this resource refuses one for two of the
// four families.
//
