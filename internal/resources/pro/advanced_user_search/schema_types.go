...
// advancedUserSearchTimeoutAttributeTypes defines the timeout attribute types
// for the advanced user search resource operations.
var advancedUserSearchTimeoutAttributeTypes = map[string]attr.Type{
