...
func (d *DigicertDataSource) Schema(ctx context.Context, req datasource.SchemaRequest, resp *datasource.SchemaResponse) {
	resp.Schema = schema.Schema{
		MarkdownDescription: "Look up a Jamf Pro DigiCert Trust Lifecycle Manager integration by ID. The certificate bytes and password are never exposed — Jamf Pro does not return them on read.",
