...
func assignConnectionModel(c *proclassic.LdapServerConnection, existingAccount *ldapAccountModel) *ldapConnectionModel {
	...
	return &ldapConnectionModel{
		...
		ConnectionTimeout:  int64ValueFromPtr(c.OpenCloseTimeout),
		SearchTimeout:      int64ValueFromPtr(c.SearchTimeout),
		...
		MigratedToID:       int64ValueFromPtr(c.MigratedToID),
