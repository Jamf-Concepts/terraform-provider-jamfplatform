...
func (d *SelfServiceMacosSettingsDataSource) Schema(ctx context.Context, req datasource.SchemaRequest, resp *datasource.SchemaResponse) {
	resp.Schema = schema.Schema{
		MarkdownDescription: "Read the current Self Service for macOS app settings (Settings > Self Service > macOS). Singleton — one record per tenant." + dataSourcePrivileges,
