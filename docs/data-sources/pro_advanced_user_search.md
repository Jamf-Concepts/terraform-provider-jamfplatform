...
page_title: "jamfplatform_pro_advanced_user_search Data Source - terraform-provider-jamfplatform"
subcategory: ""
description: |-
...
- `id` (String) Advanced user search ID. Mutually exclusive with `name`.
- `name` (String) Advanced user search display name (exact match). Mutually exclusive with `id`.
...
- `display_fields` (Set of String) Column names shown in the search results.
