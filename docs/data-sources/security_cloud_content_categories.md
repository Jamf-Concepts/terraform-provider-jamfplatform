...
description: |-
  ...
  Use this to reference a category without hard-coding a name that may be revised — in an output, or to pre-stage an identifier. Note that a category has two names: reference display_name, not name.
