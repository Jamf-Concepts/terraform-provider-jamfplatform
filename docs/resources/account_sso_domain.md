...
- `id` (String) Identifier Jamf Account assigned to the claim. It is not stable — withdrawing a claim and making it again yields a different one — so reference a domain by `domain` rather than by this.
