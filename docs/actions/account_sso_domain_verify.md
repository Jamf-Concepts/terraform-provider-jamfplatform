...
- `domain` (String) The claimed domain to verify, as it appears on Jamf Account's **Single Sign-On > Domains** page, such as `example.com`. Case is ignored: Jamf Account stores a claimed domain in lower case however it was claimed.
